...
public class PropertyLoader {
    ...
    public static Capabilities loadCapabilities() throws IOException {
        ...
        return loadCapabilities(
                System.getProperty("application.properties", DEBUG_PROPERTIES));
    }
    ...
    public static Capabilities loadCapabilities(String fromResource)
        ...
        if (props.getProperty("browser.platform") != null
                && !props.getProperty("browser.platform").equals("")) {
            capabilities.setPlatform(
                    Platform.valueOf(props.getProperty("browser.platform")));
        }
